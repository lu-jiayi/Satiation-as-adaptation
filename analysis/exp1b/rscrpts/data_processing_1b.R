...
library(brms)
`%notin%` <- Negate(`%in%`)
data<-read.csv("../../../raw_data/satiation_1b_98item-trials.csv")
...
ggsave("../graphs/subject_variability_1b.pdf", width=20, height = 25)
...
ggsave("../graphs/satiation_1b_plot.pdf",width=5,height=2.5)
